...
def generate_launch_description():
    ...
    default_world_path = urdf_tutorial_path + '/world/aws-robomaker-hospital-world/worlds/hospital.world'
    ...
    # 启动路径可视化节点
    path_visualizer_node = launch_ros.actions.Node(
    ...
    return launch.LaunchDescription([
        ...
        launch_gazebo,
        spawn_entity_node,
        path_visualizer_node,  # 添加路径可视化节点
        # 事件动作，当加载机器人结束后执行    
